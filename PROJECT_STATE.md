# AI-FILM-SERVER — intended canonical content V76
...
NEXT_ACTION: "Author dev23 only within the reviewed source/test allowlist; run TD006+TD007 and full author regression, freeze exact candidate, then hand to Claude CODE_REVIEW. Native gates remain closed."
```
