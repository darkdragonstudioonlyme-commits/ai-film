...
OLD_TX="PRODLIKE-DEV23-1CE088A-004"
...
def validate_inputs(args):
    ...
    req(witness.get("current_target")==DEV23 and witness.get("current_verify_runtime",{}).get("exists") is False,
        "HOST_WITNESS_CURRENT")
    req(witness.get("all_timers_enabled_active") is True and witness.get("deployment_receipt",{}).get("exists") is False,
        "HOST_WITNESS_STATE")
