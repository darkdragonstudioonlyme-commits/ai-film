...
STATE: BLOCKED
BLOCK_REASON_CLASS: PRODLIKE_DEV22_MIGRATION_REVIEW_AND_LOCAL_AUTHORITY_PACKAGE
...
- Prodlike dev22 migration design is `validation/PRODLIKE_DEV22_MIGRATION-P00.md`; it introduces a manifest-bound 64-file reviewed control source and exact dev22 release/rebuild builders. Live deployment is not started and remains review/audit gated.
