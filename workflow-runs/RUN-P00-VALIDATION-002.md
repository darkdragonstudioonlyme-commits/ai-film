...
STATE: BLOCKED
BLOCK_REASON_CLASS: LOCAL_KEY_AND_DEV22_LAB_PREPARATION
...
- Committed local trust anchor intentionally remains `PENDING_LOCAL_KEY` until this tooling transaction is independently reviewed/audited. No private key has been generated yet.
