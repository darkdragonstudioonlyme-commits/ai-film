...
- Current prodlike runtime/control plane is exact dev22 and READY for non-native operations. The stopped LAB still contains dev21 product bytes and must be rebuilt/resealed to exact dev22 before V02 can close or V03 can start.
...
| V02_LOCAL_OPERATOR_LAB_AUTHORITY | BLOCKED | rebuild/seal exact dev22 LAB, sign and verify the exact current authority graph |
