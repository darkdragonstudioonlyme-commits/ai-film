...
- The prior local-key activation is superseded by V02-LOCAL-KEY-PARITY-001 because its reviewed public identity has no corresponding durable private key. A corrected reactivation binds the durable owner-only WSL key through private-derived-public parity, metadata and trust-anchor identity and remains pending independent review/audit/deployment.
